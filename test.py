...
async def main():
    ...
    # p_application_headers = await db.fetch_all("SELECT id FROM mortgage_staging_v2.p_application_headers;")
    ...
    #     "SELECT id, p_application_header_id FROM mortgage_staging_v2.p_borrowing_details;"
    # )
