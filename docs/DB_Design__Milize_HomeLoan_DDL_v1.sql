...
CREATE TABLE `p_applicant_persons` (
  ...
  `district_kanji` varchar(60) DEFAULT NULL COMMENT '町村字丁目　漢字',
  ...
  `office_district_kanji` varchar(60) DEFAULT NULL COMMENT '勤務先　町村字丁目　漢字',
  ...
  `transfer_office_district_kanji` varchar(60) DEFAULT NULL COMMENT '出向（派遣）先　町村字丁目　漢字',
...
CREATE TABLE `p_application_headers` (
  ...
  `property_district` varchar(60) DEFAULT NULL COMMENT '物件　以下地番',
...
CREATE TABLE `p_residents` (
  ...
  `district_kanji` varchar(60) DEFAULT NULL COMMENT '町村字丁目／丁目･番地･号　漢字',
