...
CREATE TABLE `p_applicant_persons` (
  ...
  `spouse` tinyint DEFAULT '0' COMMENT '配偶者有無',
  ...
  `district_kana` varchar(60) DEFAULT NULL COMMENT '町村字丁目　カナ',
  ...
  `office_district_kana` varchar(60) DEFAULT NULL COMMENT '勤務先　町村字丁目　カナ',
...
CREATE TABLE `p_application_headers` (
  ...
  `sales_company` varchar(48) DEFAULT NULL COMMENT '紹介会社',
  `sales_area` varchar(48) DEFAULT NULL COMMENT 'エリア',
  `sales_exhibition_hall` varchar(48) DEFAULT NULL  COMMENT '展示場',
  `sales_host_company_id` bigint unsigned DEFAULT NULL COMMENT 'メイン会社ID',
  ...
  `property_district` varchar(40) DEFAULT NULL COMMENT '物件　以下地番',
  ...
  `required_funds_land_amount` bigint DEFAULT "0" COMMENT '必要資金　土地価格',
  `required_funds_house_amount` bigint DEFAULT "0" COMMENT '必要資金　建物・物件価格・マンション価格',
  `required_funds_accessory_amount` bigint DEFAULT "0" COMMENT '必要資金　付帯設備',
  `required_funds_additional_amount` bigint DEFAULT "0" COMMENT '必要資金　諸費用等',
  `required_funds_refinance_loan_balance` bigint DEFAULT "0" COMMENT '必要資金　借換対象ローン残債',
  `required_funds_upgrade_amount` bigint DEFAULT "0" COMMENT '必要資金　増改築',
  `required_funds_loan_plus_amount` bigint DEFAULT "0" COMMENT '必要資金　住宅ローンプラス',
  `required_funds_total_amount` bigint DEFAULT "0" COMMENT '必要資金　必要資金合計',
  `funding_saving_amount` bigint DEFAULT "0" COMMENT '調達資金　預貯金',
  `funding_other_saving_amount` bigint DEFAULT "0" COMMENT '調達資金　有価証券等',
  `funding_estate_sale_amount` bigint DEFAULT "0" COMMENT '調達資金　不動産売却代金',
  `funding_self_amount` bigint DEFAULT "0" COMMENT '調達資金　自己資金',
  `funding_relative_donation_amount` bigint DEFAULT "0" COMMENT '調達資金　親族からの贈与',
  `funding_loan_amount` bigint DEFAULT "0" COMMENT '調達資金　本件ローン',
  `funding_pair_loan_amount` bigint DEFAULT "0" COMMENT '調達資金　ペアローン',
  `funding_other_amount` bigint DEFAULT "0" COMMENT '調達資金　その他額',
  `funding_other_amount_detail` varchar(48) DEFAULT NULL COMMENT '調達資金　その他額名',
  `funding_other_loan_amount` bigint DEFAULT "0" COMMENT '調達資金　その他の借り入れ',
  `funding_other_refinance_amount` bigint DEFAULT "0" COMMENT '調達資金　その他借換',
  `funding_total_amount` bigint DEFAULT "0" COMMENT '調達資金　調達資金合計',
...
CREATE TABLE `p_examine_status_error_logs` (
  `id` bigint unsigned NOT NULL COMMENT 'ID',
  `p_application_bank_id` bigint unsigned DEFAULT NULL COMMENT '申込銀行ID',
  `s3_key` varchar(128) NOT NULL COMMENT 's3キー',
  `s3_bucket` varchar(128) NOT NULL COMMENT 's3バケット',
  `soudan_no` varchar(10) DEFAULT NULL COMMENT '申込認識番号',
...
CREATE TABLE `p_residents` (
  ...
  `postal_code` varchar(8) DEFAULT NULL COMMENT '郵便番号',
  `prefecture_kanji` varchar(20) DEFAULT NULL COMMENT '都道府県　漢字',
  `city_kanji` varchar(20) DEFAULT NULL COMMENT '市区郡／市区町村　漢字',
  `district_kanji` varchar(40) DEFAULT NULL COMMENT '町村字丁目／丁目･番地･号　漢字',
  `other_address_kanji` varchar(99) DEFAULT NULL COMMENT '補足／建物名･部屋番号等　漢字',
  `prefecture_kana` varchar(20) DEFAULT NULL COMMENT '都道府県　カナ',
  `city_kana` varchar(20) DEFAULT NULL COMMENT '市区郡／市区町村　カナ',
  `district_kana` varchar(60) DEFAULT NULL COMMENT '町村字丁目／丁目･番地･号　カナ',
  `other_address_kana` varchar(138) DEFAULT NULL COMMENT '補足／建物名･部屋番号等　カナ',
